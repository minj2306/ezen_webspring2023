...
public class BoardEntity extends BaseTime { // 테이블 설계
    ...
    @JoinColumn( name = "mno_fk" ) // FK 필드로 사용 ( name = "fk 필드명" )
    @ManyToOne // 다수가 하나일때
    ...
    public BoardDto allToDto(){
        return BoardDto.builder()
                        ...
                        .memail(this.memberEntity.getMemail()) //작성자 아이디 [ fk 연결된 필드 ]
                        .cdate( toTimeOrDate( this.getCdate() ) ) // 구글링 : Java LocalDateTime 변환
